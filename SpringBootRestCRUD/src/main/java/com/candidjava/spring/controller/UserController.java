...
public class UserController {
    ...
    /**
     * This method will accept a Json bcoz headers="Accept=application/json
     * The Json will be converted into User object bcoz we have @RequestBody User user as the argument
     * @param user
     * @param ucBuilder
     * @return
     */
